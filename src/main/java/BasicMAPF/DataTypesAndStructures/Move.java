...
public class Move {
    ...
    /**
     * Construction fot Move
     * @param agent - the agent that moves
     * @param timeNow - the time after the move
     * @param prevLocation - if the agent move from v0 to v1 -> this.prevLocation == v0
     * @param currLocation - if the agent move from v0 to v1 -> this.currLocation == v1
     */
