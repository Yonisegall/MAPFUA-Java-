...
public class Solution implements Iterable<SingleAgentPlan>{
    ...
    // Cost Functions for NUA problem:
    /**
     * Calculate the SST
     */
    public int SST() {
    ...
    /**
     * Calculate the FUEL just for the assigned steps, not counting the fuel for the steps after the agent reaches its goal (if it keeps moving after reaching the goal).
     */
   ...
   /////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public String toString() {
        ...
        sb.append(" | NUA = ").append(this.NUA());
        sb.append(" | SST = ").append(this.SST());
        sb.append(" | SST_All = ").append(this.SST_All());
        sb.append(" | Fuel_Assigned = ").append(this.Fuel_Assigned());
        sb.append(" |");
        sb.append('\n');
        sb.append('\n');
        return sb.toString();
