...
public class LaCAMStar_Solver extends A_Solver {
    ...
    protected Solution runAlgorithm(MAPF_Instance instance, RunParameters parameters) {
        ...
        this.lacamSolver.explored.put(new NodeKey(initialConfiguration, N_init.movedUA), N_init);
        //////////////////////////////////////////////////////////////////////////////////////////////  
        ...
        while (!this.lacamSolver.open.empty() && !checkTimeout()) {
            ...
            NodeKey nextKey = new NodeKey(newConfiguration, this.lacamSolver.transitionMovedUA);
            HighLevelNodeStar reInsertionNode = (HighLevelNodeStar) this.lacamSolver.explored.get(nextKey);
            ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if (reInsertionNode != null) {
                ...
                this.lacamSolver.explored.put(new NodeKey(newConfiguration, N_new.movedUA), N_new);
                ////////////////////////////////////////////////////////////////////////////////////////////////////
