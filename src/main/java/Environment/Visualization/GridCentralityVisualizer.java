...
import static Environment.Visualization.MillimetricCoordinatesGraphSolutionVisualizer.flattenedGraph;
import static Environment.Visualization.MillimetricCoordinatesGraphSolutionVisualizer.paintAroundCoordinate;
import static Environment.Visualization.MillimetricCoordinatesGraphSolutionVisualizer.paintVertices;
...
public class GridCentralityVisualizer {
    ...
    public static void visualizeCentrality(I_GridMap map, Map<I_Location, Double> locationCentrality, String title) {
        ...
        grids.add(grid);
        GridVisualizer.visualize(grids, null, 250, title, null, null, null);
    }
